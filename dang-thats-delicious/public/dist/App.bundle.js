...
function autocomplete(input, latInput, lngInput) {
  if (!input) return; // skip this function from running if no input on the page
  ...
  // if someone hits enter ont he address field, don't submit the form
